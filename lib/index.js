...
module.exports.configure = function (settings) {
    ...
    settings.forEach(function (setting) {
        ...
        if(!logLevels[setting.level]) {
            setting.level = 'log';
        }
        if(!setting.appender) {
            setting.appender = 'console';
        }
    });
