 ...
 * @module logger
 * @requires logger/appenders/console
 * @requires logger/appenders/no-op
 * @requires util
 */
...
module.exports = function (moduleName) {
    ...
    process.SOUL_LOGGER.forEach(function (setting) {
 ...
 * @function
 * @name module:logger.configure
 * @param {Array.<module:logger~LoggerSettings>} settings - the settings used for logger
 */
module.exports.configure = function (settings) {
    ...
    process.SOUL_LOGGER = settings;
};
// documenting the Logger object returned by the logger module
/**
 * The logger object used to log messages
 * @typedef {object} module:logger~Logger
 * @property {module:logger~LoggingFunction} log - least priority logging function
 * @property {module:logger~LoggingFunction} info - third highest priority logging function
 * @property {module:logger~LoggingFunction} warn - second highest priority logging function
 * @property {module:logger~LoggingFunction} error - highest priority logging function
 */
 ...
 * as parameter.
 * @callback module:logger~LoggingFunction
 ...
 * @typedef {object} module:logger~LoggerSettings
 ...
 * @property {string} [level='log'] - the log level filters the actual {@link module:logger~LoggingFunction} in the 
 * {@link module:logger~Logger} object that are considered for logging. Those with priority lower than the passed 
