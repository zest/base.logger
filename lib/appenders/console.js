...
module.exports = function (moduleName) {
    ...
    var prefix = format(('                              ' + moduleName).slice(-32), ['italic', 'grey']) + ' | ';
    return {
        debug: function () {
            console.log(spitString(arguments, ['blue'], prefix));
        },
        info: function () {
            console.log(spitString(arguments, ['green'], prefix));
        },
        warn: function () {
            console.log(spitString(arguments, ['yellow'], prefix));
        },
        error: function () {
